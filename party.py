...
def is_mel(name, email):
    ...
    False
    >>> is_mel("Mel Melitpolski"," carol@ubermelon.com") 
    True
    >>> is_mel("Carol Freitas", "mel@ubermelon.com")
    True
    ...
    """
    mels = ["Mel", "Mel Melitpolski", "Melitpolski"]

    return name.title() in mels or email.lower() == "mel@ubermelon.com"
